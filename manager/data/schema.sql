...
CREATE TABLE `locations_probes` (`probe_id` integer,`location_id` integer,PRIMARY KEY (`probe_id`,`location_id`),CONSTRAINT `fk_locations_probes_location` FOREIGN KEY (`location_id`) REFERENCES `locations`(`id`),CONSTRAINT `fk_locations_probes_probe` FOREIGN KEY (`probe_id`) REFERENCES `probes`(`id`));

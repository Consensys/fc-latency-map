...
require (
	...
	github.com/filecoin-project/go-data-transfer v1.7.2 // indirect
	github.com/filecoin-project/go-fil-markets v1.6.2 // indirect
	...
	github.com/ipfs/go-graphsync v0.6.6 // indirect
